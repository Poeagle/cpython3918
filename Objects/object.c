...
#undef CHECK
    ...
    PyObject_CallFinalizerFromDealloc(PyObject *self)
    {
        ...
        _PyObject_ASSERT(self,
                         (!_PyType_IS_GC(Py_TYPE(self)) || _PyObject_GC_IS_TRACKED(self)));
    ...
    */
    ...
    _PyObject_GetMethod(PyObject *obj, PyObject *name, PyObject **method)
    {
        ...
        if (Py_TYPE(obj)->tp_getattro != PyObject_GenericGetAttr || !PyUnicode_Check(name))
        {
    ...
    */
    ...
    PyObject _Py_NoneStruct = {
        _PyObject_EXTRA_INIT 1, &_PyNone_Type};
