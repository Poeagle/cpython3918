...
subtype_traverse(PyObject *self, visitproc visit, void *arg)
{
    ...
    if (type->tp_flags & Py_TPFLAGS_HEAPTYPE && (!basetraverse || !(base->tp_flags & Py_TPFLAGS_HEAPTYPE)))
    {
...
subtype_dealloc(PyObject *self)
{
    ...
    if (!_PyType_IS_GC(type))
    {
        ...
        int type_needs_decref = (type->tp_flags & Py_TPFLAGS_HEAPTYPE && !(base->tp_flags & Py_TPFLAGS_HEAPTYPE));
...
subtype_getweakref(PyObject *obj, void *context)
{
    ...
    _PyObject_ASSERT((PyObject *)type,
                     ((type->tp_weaklistoffset + sizeof(PyObject *)) <= (size_t)(type->tp_basicsize)));
...
static PyMethodDef type_methods[] = {
    TYPE_MRO_METHODDEF
        TYPE___SUBCLASSES___METHODDEF{"__prepare__", (PyCFunction)(void (*)(void))type_prepare,
